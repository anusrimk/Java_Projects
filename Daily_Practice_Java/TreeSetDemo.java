...
public class TreeSetDemo {
    public static void main(String[] args) {
        ...
        System.out.println("ts: " + ts); // GG has been added in ts also. This means that s and ts are referring to the same objects
        ...
        List<Integer> list = List.of(144, 22, 11, 33, 22);
        ...
        Set<Double> ts2 = new TreeSet<>(hs);
        System.out.println("Created TreeSet from HashSet: " + ts2);

        LinkedList<Double> ll = new LinkedList<>(hs);
        ll.add(55.9);
        System.out.println("Created LinkedList from HashSet: " + ll);

        TreeSet<Double> ts3 = new TreeSet<>(ll);
        System.out.println("Created TreeSet from LinkedList: " + ts3);

        // Uncommenting the following line will cause an IllegalArgumentException due to duplicate elements
        // Set<Integer> set = Set.of(77, 44, 33, 22, 44, 22); // java.lang.IllegalArgumentException: duplicate element

        Set<Integer> set = Set.of(77, 44, 33, 22);
        System.out.println("Set.of: " + set);

        // Uncommenting the following line will cause UnsupportedOperationException
        // Set<Double> sof1 = Set.copyOf(ll);
        // System.out.println("Set.copyOf: " + sof1);
        // System.out.println("sof1.add(20.5): " + sof1.add(20.5)); // java.lang.UnsupportedOperationException
    }
}